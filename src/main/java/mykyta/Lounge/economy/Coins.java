...
public class Coins implements Economy {
    ...
    public double getBalance(String p) {
        return data.getCoins(Bukkit.getOfflinePlayer(p));
    }

    @Override
    public double getBalance(OfflinePlayer p) {
        return data.getCoins(p);
    }
    ...
    public EconomyResponse withdrawPlayer(String p, double amount) {
        data.incrementCoins(Bukkit.getOfflinePlayer(p), -amount);
        return null;
    }

    @Override
    public EconomyResponse withdrawPlayer(OfflinePlayer p, double amount) {
        data.incrementCoins(p, -amount);
        return null;
    }
